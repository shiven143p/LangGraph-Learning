...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/workspaces/LangGraph-Learning/venv/bin',
 'BINLIBDEST': '/workspaces/LangGraph-Learning/venv/lib/python3.12',
 'BLDLIBRARY': 'libpython3.12.a',
 'BLDSHARED': 'gcc -pthread -B /workspaces/LangGraph-Learning/venv/compiler_compat -shared  '
              ''
              ''
              '-Wl,-rpath,/workspaces/LangGraph-Learning/venv/lib '
              '-Wl,-rpath-link,/workspaces/LangGraph-Learning/venv/lib '
              '-L/workspaces/LangGraph-Learning/venv/lib '
              ''
              ''
              '-Wl,-rpath,/workspaces/LangGraph-Learning/venv/lib '
              '-Wl,-rpath-link,/workspaces/LangGraph-Learning/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /workspaces/LangGraph-Learning/venv/compiler_compat',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-overflow -DNDEBUG -O2 -Wall  '
           '-fPIC  '
           '-O2   -isystem '
           '/workspaces/LangGraph-Learning/venv/include '
           ''
           ''
           ''
           '-fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/workspaces/LangGraph-Learning/venv/include '
                       '-I/workspaces/LangGraph-Learning/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-rpath,/workspaces/LangGraph-Learning/venv/lib '
                      '-Wl,-rpath-link,/workspaces/LangGraph-Learning/venv/lib '
 ...
 'CONFIG_ARGS': "'--prefix=/workspaces/LangGraph-Learning/venv'"
                "'--build=x86_64-conda_cos6-linux-gnu'"
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/workspaces/LangGraph-Learning/venv/share/zoneinfo:/workspaces/LangGraph-Learning/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-expat'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/workspaces/LangGraph-Learning/venv/include'"
                "'--with-tcltk-libs=-L/workspaces/LangGraph-Learning/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/workspaces/LangGraph-Learning/venv/lib/pkgconfig'"
 ...
 'CONFINCLUDEDIR': '/workspaces/LangGraph-Learning/venv/include',
 'CONFINCLUDEPY': '/workspaces/LangGraph-Learning/venv/include/python3.12',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/workspaces/LangGraph-Learning/venv/include '
             '-I/workspaces/LangGraph-Learning/venv/include',
 'CXX': 'g++ -pthread -B /workspaces/LangGraph-Learning/venv/compiler_compat',
 ...
 'DESTDIRS': '/workspaces/LangGraph-Learning/venv '
             '/workspaces/LangGraph-Learning/venv/lib '
             '/workspaces/LangGraph-Learning/venv/lib/python3.12 '
             '/workspaces/LangGraph-Learning/venv/lib/python3.12/lib-dynload',
 'DESTLIB': '/workspaces/LangGraph-Learning/venv/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/workspaces/LangGraph-Learning/venv/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/workspaces/LangGraph-Learning/venv/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 ...
 'INCLDIRSTOMAKE': '/workspaces/LangGraph-Learning/venv/include '
                   '/workspaces/LangGraph-Learning/venv/include '
                   '/workspaces/LangGraph-Learning/venv/include/python3.12 '
                   '/workspaces/LangGraph-Learning/venv/include/python3.12',
 'INCLUDEDIR': '/workspaces/LangGraph-Learning/venv/include',
 'INCLUDEPY': '/workspaces/LangGraph-Learning/venv/include/python3.12',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /workspaces/LangGraph-Learning/venv/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/workspaces/LangGraph-Learning/venv/lib '
            '-Wl,-rpath-link,/workspaces/LangGraph-Learning/venv/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -B /workspaces/LangGraph-Learning/venv/compiler_compat -shared  '
             ''
             ''
             '-Wl,-rpath,/workspaces/LangGraph-Learning/venv/lib '
             '-Wl,-rpath-link,/workspaces/LangGraph-Learning/venv/lib '
 ...
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/workspaces/LangGraph-Learning/venv/lib/python3.12',
 'LIBDIR': '/workspaces/LangGraph-Learning/venv/lib',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/workspaces/LangGraph-Learning/venv/lib/pkgconfig',
 'LIBPL': '/workspaces/LangGraph-Learning/venv/lib/python3.12/config-3.12-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread -B /workspaces/LangGraph-Learning/venv/compiler_compat',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/workspaces/LangGraph-Learning/venv/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': '/croot/python-split_1696267002197/work/Modules/makesetup',
 'MANDIR': '/workspaces/LangGraph-Learning/venv/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/workspaces/LangGraph-Learning/venv/include',
 'MODULE_BINASCII_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/workspaces/LangGraph-Learning/venv/include',
 'MODULE_ZLIB_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                        '-lz',
 ...
 'MODULE__CTYPES_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                           '-lffi -ldl',
 ...
 'MODULE__CURSES_CFLAGS': '-D_GNU_SOURCE -DNCURSES_WIDECHAR '
                          '-I/workspaces/LangGraph-Learning/venv/include/ncursesw '
                          '-I/workspaces/LangGraph-Learning/venv/include',
 'MODULE__CURSES_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                           ''
                           ''
                           '-Wl,-rpath,/workspaces/LangGraph-Learning/venv/lib '
                           '-Wl,-rpath-link,/workspaces/LangGraph-Learning/venv/lib '
 ...
 'MODULE__CURSES_PANEL_CFLAGS': '-D_GNU_SOURCE -DNCURSES_WIDECHAR '
                                ...
                                '-I/workspaces/LangGraph-Learning/venv/include/ncursesw '
                                '-I/workspaces/LangGraph-Learning/venv/include',
 'MODULE__CURSES_PANEL_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                                 ''
                                 ''
                                 '-Wl,-rpath,/workspaces/LangGraph-Learning/venv/lib '
                                 '-Wl,-rpath-link,/workspaces/LangGraph-Learning/venv/lib '
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/workspaces/LangGraph-Learning/venv/include',
 'MODULE__HASHLIB_DEPS': '/croot/python-split_1696267002197/work/Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/workspaces/LangGraph-Learning/venv/include',
 'MODULE__LZMA_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/workspaces/LangGraph-Learning/venv/include '
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/workspaces/LangGraph-Learning/venv/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/workspaces/LangGraph-Learning/venv/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
 ...
 'MODULE__UUID_CFLAGS': '-I/workspaces/LangGraph-Learning/venv/include/uuid',
 'MODULE__UUID_LDFLAGS': '-L/workspaces/LangGraph-Learning/venv/lib '
                         '-luuid',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/workspaces/LangGraph-Learning/venv/lib',
 ...
 'TIMEMODULE_LIB': 0,
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/workspaces/LangGraph-Learning/venv/share/zoneinfo:/workspaces/LangGraph-Learning/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'WASM_ASSETS_DIR': './workspaces/LangGraph-Learning/venv',
 'WASM_STDLIB': './workspaces/LangGraph-Learning/venv/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/workspaces/LangGraph-Learning/venv/share',
 'exec_prefix': '/workspaces/LangGraph-Learning/venv',
